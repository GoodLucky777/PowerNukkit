...
public class PopulatorBamboo extends PopulatorSurfaceBlock {
    ...
    private static final BlockBamboo BLOCK_BAMBOO = (new BlockBamboo()).setThick(true);
    private static final BlockBamboo BLOCK_BAMBOO_LEAF_SMALL = BLOCK_BAMBOO.setLeafSize(BlockBamboo.LEAF_SIZE_SMALL);
    private static final BlockBamboo BLOCK_BAMBOO_LEAF_LARGE = BLOCK_BAMBOO.setLeafSize(BlockBamboo.LEAF_SIZE_LARGE);
    private static final BlockBamboo BLOCK_BAMBOO_LEAF_LARGE_AGED = BLOCK_BAMBOO_LEAF_LARGE.setAged(1);
