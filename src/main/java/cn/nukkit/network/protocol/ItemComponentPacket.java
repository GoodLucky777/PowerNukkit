...
public class ItemComponentPacket extends DataPacket {
    ...
    public static final Entry[] entries = {
        ...
        new Entry("goodlucky:fried_chicken",
            getFoodItemComponent("goodlucky:fried_chicken", 5406, "goodlucky:fried_chicken", 64, 3, 1, 32, 8, false, 0.6f)
        ),
        new Entry("goodlucky:fried_chicken_leg",
            getFoodItemComponent("goodlucky:fried_chicken_leg", 5407, "goodlucky:fried_chicken_leg", 64, 3, 1, 32, 1, false, 0.3f)
        ),
        new Entry("goodlucky:fried_egg",
            getFoodItemComponent("goodlucky:fried_egg", 5408, "goodlucky:fried_egg", 64, 3, 1, 32, 1, false, 0.3f)
        ),
        new Entry("goodlucky:apple_pie",
            getFoodItemComponent("goodlucky:apple_pie", 5409, "goodlucky:apple_pie", 64, 3, 1, 32, 13, false, 0.6f)
        ),
        new Entry("goodlucky:pretzel",
            getFoodItemComponent("goodlucky:pretzel", 5410, "goodlucky:pretzel", 64, 3, 1, 32, 15, false, 0.6f)
        ),
        new Entry("goodlucky:whiskey",
            getFoodItemComponent("goodlucky:whiskey", 5411, "goodlucky:whiskey", 64, 3, 1, 32, 1, true, 0.1f)
        ),
        new Entry("goodlucky:wine",
            getFoodItemComponent("goodlucky:wine", 5412, "goodlucky:wine", 64, 3, 1, 32, 1, true, 0.1f)
        ),
