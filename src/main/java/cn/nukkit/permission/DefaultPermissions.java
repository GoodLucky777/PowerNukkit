...
public abstract class DefaultPermissions {
    ...
    public static void registerCorePermissions() {
        ...
        registerPermission(new Permission(ROOT + ".command.daylock", "Allows the user to lock daylight cycle", Permission.DEFAULT_OP), commands);
        registerPermission(new Permission(ROOT + ".command.setmaxplayers", "Allows the user to set max players of the server", Permission.DEFAULT_OP), commands);
